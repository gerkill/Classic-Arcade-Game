...
var Engine = (function(global) {
	...
	function render() {
		...
		switch (currentGameState) {
			case "startGame":
				// Display an empty game board with instructions text here
				var rowImages = ['images/water-block.png', // Top row is water
						'images/stone-block.png', // Row 1 of 3 of brick roadway
						'images/stone-block.png', // Row 2 of 3 of brick roadway
						'images/stone-block.png', // Row 3 of 3 of brick roadway
				...
				for (row = 0; row < numRows; row++) {
					for (col = 0; col < numCols; col++) {
						...
						ctx.fillText("Can You Avoid the Bugs?", canvas.width / 2, canvas.height / 5.5);
						ctx.fillStyle = "black";
						ctx.font = "20px Comic Sans MS";
						ctx.textAlign = "center";
						ctx.fillText("To Start, Press ENTER", canvas.width / 2, canvas.height / 4);
						ctx.fillStyle = "black";
						ctx.font = "18px Comic Sans MS";
						ctx.textAlign = "center";
						ctx.fillText("Navigate around the board using your arrow keys", canvas.width / 2, canvas.height / 2.3);
						ctx.fillText("Reach water: score 20. Score 40 when you get a Golden Key!", canvas.width / 2, canvas.height / 2.0);
						ctx.fillText("Game difficulty increases each time you reach the water", canvas.width / 2, canvas.height / 1.75);
						ctx.fillText("You start with 3 lives. Collect Hearts for extra lives", canvas.width / 2, canvas.height / 1.5);
						ctx.fillText("Avoid the moving Bugs to stay alive in the game!", canvas.width / 2, canvas.height / 1.3);
						ctx.fillStyle = "red";
						ctx.font = "20px Comic Sans MS";
						ctx.textAlign = "center";
						ctx.fillText("Fortune Favors the Brave!", canvas.width / 2, canvas.height / 1.1);
					}
				}
				break;
			case "inGame":
				// Draw the game board, plus renderEntities 
				...
				break;
			case "gameOver":
				// Display an empty game board with 'Game Over'text here
				rowImages = ['images/water-block.png', // Top row is water
				...
				for (row = 0; row < numRows; row++) {
					for (col = 0; col < numCols; col++) {
						...
						ctx.textAlign = "center";
						ctx.fillText("Press Enter To Restart", canvas.width / 2, canvas.height / 2.1);
					}
				}
				break;
		}
	 ...
	 */
	Resources.load(['images/stone-block.png', 'images/water-block.png', 'images/grass-block.png', 'images/enemy-bug.png', 'images/char-horn-girl.png', 'images/Key.png', 'images/Heart.png', ]);
